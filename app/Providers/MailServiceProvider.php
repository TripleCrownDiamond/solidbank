    ...
    public function boot(): void
    {
        ...
        Event::listen(MessageSending::class, function (MessageSending $event) {
            try {
                ...
                $bankName = \App\Helpers\BankConfigHelper::get('bank_name', 'SolidBank');
                $headers->addTextHeader('X-Mailer', $bankName . ' Mail System v1.0');
                ...
                $headers->addTextHeader('X-Content-Filtered-By', $bankName . ' Security');
                ...
                $headers->addTextHeader('X-' . str_replace(' ', '', $bankName) . '-Service', 'Account-Management');
                ...
                $headers->addTextHeader('X-Message-ID', uniqid(strtolower(str_replace(' ', '', $bankName)) . '_', true));
                ...
                // En cas d'erreur, ne pas ajouter les en-têtes personnalisés
                // L'email sera envoyé avec les en-têtes par défaut
            }
        });
    }
}
