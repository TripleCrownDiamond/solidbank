    ...
    <section class="relative text-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 rounded-xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto">
            ...
            <div class="flex flex-col items-center text-center lg:hidden">
                ...
                <h1 class="text-3xl sm:text-4xl font-extrabold mb-4 leading-tight">{{ __('common.contact_us') }}&nbsp;: <span class="text-blue-100">{{ config('app.name', 'Celesium-Fin') }}</span></h1>
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-12">
                ...
                <div class="flex-1 text-left pr-6">
                    ...
                    <h1 class="text-5xl font-extrabold mb-4 leading-tight">{{ __('common.contact_us') }}&nbsp;: <span class="text-blue-100">{{ config('app.name', 'Celesium-Fin') }}</span></h1>
                ...
                <div class="space-y-8 sm:space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-6 lg:gap-x-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <a href="mailto:{{ \App\Models\Config::first()?->bank_email ?? 'contact@Celesium-Fin.com' }}" class="text-brand-primary hover:text-brand-accent font-medium break-all">{{ \App\Models\Config::first()?->bank_email ?? 'contact@Celesium-Fin.com' }}</a>
                        </div>
                    </div>
