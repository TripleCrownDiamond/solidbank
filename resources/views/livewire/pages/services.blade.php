<div class="services-container space-y-16">
    ...
    <section class="relative text-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 rounded-xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <div class="relative z-10 max-w-7xl mx-auto">
            <div class="text-center">
                <span class="inline-block bg-blue-500 text-white px-3 py-1 rounded-full mb-4 font-medium text-sm sm:text-base">{{ __('common.our_services') }}</span>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                    <a href="{{ route('locale.register', ['locale' => app()->getLocale()]) }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg shadow transition duration-200 text-center">{{ __('common.open_account') }}</a>
                ...
                <div class="space-y-8 sm:space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-6 lg:gap-x-8 md:gap-y-8 lg:gap-y-10">
                    ...
                    <div class="relative">
                        ...
                        <div class="ml-16">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('loan-request', ['locale' => app()->getLocale()]) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white text-sm font-medium rounded-lg shadow transition duration-300 transform hover:scale-105">
    ...
    <section class="py-8 sm:py-12 lg:py-16 relative overflow-hidden rounded-xl border border-blue-200/50 dark:border-blue-700/50 mt-8 mb-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center border border-gray-200 dark:border-gray-700">
                    <div class="text-3xl font-bold text-blue-500 mb-2">2,450+</div>
    ...
    <section class="max-w-6xl mx-auto py-8 sm:py-12 lg:py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200/50 dark:border-gray-700/50 mt-8 mb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20">
                ...
                <div class="font-bold mb-2 text-blue-600 text-center">{{ __('common.maximum_security') }}</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.1s;">
                ...
                <div class="font-bold mb-2 text-blue-600 text-center">{{ __('common.100_percent_digital') }}</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.2s;">
                ...
                <div class="font-bold mb-2 text-blue-600 text-center">{{ __('common.support_24_7') }}</div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.3s;">
                ...
                <div class="font-bold mb-2 text-blue-600 text-center">{{ __('common.total_transparency') }}</div>
    ...
    <section class="relative overflow-hidden rounded-2xl border border-white/20 mt-8 mb-8">
        <!-- Gradient animé avec effet glassmorphism -->
        <div class="absolute inset-0 bg-gradient-to-r from-brand-primary to-blue-500 animate-gradient-x"></div>
