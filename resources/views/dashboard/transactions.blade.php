            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <p class="text-blue-100 text-sm font-medium">
                        <i class="fa-solid fa-{{ Auth::user()->is_admin ? 'user-shield' : 'user' }} mr-1"></i>
                        {{ Auth::user()->is_admin ? __('common.admin_space') : __('common.user_space') }}
                    </p>
                </div>
            </div>
        </div>
