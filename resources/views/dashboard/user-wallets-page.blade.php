        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                ...
                @if($suspendedAccount && ($suspendedAccount->suspension_reason || $suspendedAccount->suspension_instructions))
                    <div class="max-w-3xl mx-auto bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-700 p-6 rounded-xl shadow-md mb-8">
