    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                <!-- 503 Number -->
                <div class="mb-6">
                    <h1 class="text-6xl font-bold text-gray-400 dark:text-gray-600">503</h1>
                </div>
                
                <!-- Error Message -->
                <div class="mb-6">
                    <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-brand-primary/20">
                        <svg class="w-8 h-8 text-brand-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('http-statuses.503') }}</h2>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.service_temporarily_unavailable') }}</p>
                </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ __('Nous travaillons à résoudre ce problème. Veuillez réessayer plus tard.') }}
            </p>
        </div>
    </div>
</x-guest-layout>