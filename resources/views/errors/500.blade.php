    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                <!-- 500 Number -->
                <div class="mb-6">
                    <h1 class="text-6xl font-bold text-gray-400 dark:text-gray-600">500</h1>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('http-statuses.500') }}</h2>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.internal_server_error') }}</p>
                </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ __('Si le problème persiste, contactez notre support technique.') }}
            </p>
        </div>
    </div>
</x-guest-layout>