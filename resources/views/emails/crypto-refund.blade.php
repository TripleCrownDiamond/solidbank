...
@section('content')
    ...
    <div style="background-color: #f9f9f9; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
        <h3 style="font-size: 18px; color: #0056b3; margin-top: 0;">Informations personnelles :</h3>
        ...
        <h3 style="font-size: 18px; color: #0056b3; margin-top: 20px;">Détails du remboursement :</h3>
        <ul style="list-style: none; padding: 0;">
        ...
        @if (!empty($refundData['additional_info']))
            <h3 style="font-size: 18px; color: #0056b3; margin-top: 20px;">Informations supplémentaires :</h3>
            <p style="font-size: 16px; line-height: 1.5; color: #333;">{{ $refundData['additional_info'] }}</p>
        @endif
    </div>
