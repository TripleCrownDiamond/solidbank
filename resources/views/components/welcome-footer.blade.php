<footer class="bg-white border-t border-gray-100 mt-8 dark:bg-gray-900 text-gray-900">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="mt-4 text-base text-gray-500">
                        {{ __('common.about_us_description', ['app_name' => $config->app_name ?? $config->bank_name ?? '']) }}
                    </p>
                </div>
                <div>
            ...
            <div class="mt-8 border-t border-gray-100 pt-8">
                ...
                @if($config && ($config->app_name || $config->bank_name))
&copy; {{ date('Y') }} {{ $config->app_name ?? $config->bank_name }}. {{ __('All rights reserved.') }}
@endif
            </p>
        </div>
    </div>
