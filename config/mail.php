...
return [
     ...
     */
    'headers' => [
        'X-Mailer' => \App\Helpers\BankConfigHelper::get('bank_name', 'Wolf Developpe') . ' Banking System',
        'X-Priority' => '1',
        'Importance' => 'High',
        'List-Unsubscribe' => function () {
            $bankEmail = \App\Helpers\BankConfigHelper::get('bank_email', 'contact@wolf-developpe.com');
