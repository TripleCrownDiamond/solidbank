    ...
    public function run(): void
    {
        ...
        Config::updateOrCreate(
            ...
            [
                ...
                'bank_email' => \App\Helpers\BankConfigHelper::get('bank_email', 'contact@privedymeeu.com'),
                'bank_website' => 'https://www.' . parse_url(\App\Helpers\BankConfigHelper::get('bank_email', 'privedymeeu.com'), PHP_URL_HOST),
                'logo_url' => 'img/privedyme-bank.svg',
                'icon_url' => 'img/icon_blue.svg',
                'favicon_url' => 'favicon.ico',
                'notification_email' => \App\Helpers\BankConfigHelper::get('bank_email', 'contact@privedymeeu.com'),
