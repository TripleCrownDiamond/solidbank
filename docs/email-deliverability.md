# Configuration de Délivrabilité Email pour Celesium-Fin
...
Type: TXT
Nom: _dmarc
Valeur: v=DMARC1; p=quarantine; rua=mailto:dmarc@celesium-fin.com; ruf=mailto:dmarc@celesium-fin.com; fo=1
```
