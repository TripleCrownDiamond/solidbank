...
```
v=DMARC1; p=quarantine; rua=mailto:dmarc@celesium-fin.com; ruf=mailto:dmarc@celesium-fin.com; fo=1
```
...
-   Utiliser `mail.Celesium-Fin.com` ou `noreply.Celesium-Fin.com`
