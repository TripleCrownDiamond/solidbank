...
```
v=DMARC1; p=quarantine; rua=mailto:dmarc@privedyme-bank.com; ruf=mailto:dmarc@privedyme-bank.com; fo=1
```
...
-   Format : `mail.privedyme-bank.com`
...
-   Utiliser `mail.privedyme-bank.com` ou `noreply.privedyme-bank.com`
