...
```
v=DMARC1; p=quarantine; rua=mailto:dmarc@privedymeeu.com; ruf=mailto:dmarc@privedymeeu.com; fo=1
```
...
-   Utiliser `mail.privedymeeu.com` ou `noreply.privedymeeu.com`
