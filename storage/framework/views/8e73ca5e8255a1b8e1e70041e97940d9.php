...
<?php endif; ?>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2"><?php echo e(__('http-statuses.404')); ?></h2>
                    <p class="text-gray-600 dark:text-gray-400"><?php echo e(__('common.page_not_found')); ?></p>
                </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Si le problème persiste, contactez notre support.')); ?>
...
<?php endif; ?><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/errors/404.blade.php ENDPATH**/ ?>