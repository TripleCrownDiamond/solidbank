...
<?php endif; ?>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2"><?php echo e(__('http-statuses.500')); ?></h2>
                    <p class="text-gray-600 dark:text-gray-400"><?php echo e(__('common.internal_server_error')); ?></p>
                </div>
                
                <!-- Action Buttons -->
                <div class="space-y-3">
                    <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/' . app()->getLocale() . '/dashboard')); ?>" 
                       class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        ...
                        <?php echo e(__('common.return_to_dashboard')); ?>
                    ...
                    <a href="<?php echo e(url('/' . app()->getLocale())); ?>" 
                       class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        ...
                        <?php echo e(__('common.return_to_home')); ?>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                <?php echo e(__('Si le problème persiste, contactez notre support technique.')); ?>
...
<?php endif; ?><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/errors/500.blade.php ENDPATH**/ ?>