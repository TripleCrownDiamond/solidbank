...
<div 
    x-data="{
        unlockCode: <?php if ((object) ('unlockCode') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('unlockCode'->value()); ?>')<?php echo e('unlockCode'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('unlockCode'); ?>')<?php endif; ?>.live,
        unlockError: <?php if ((object) ('unlockError') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('unlockError'->value()); ?>')<?php echo e('unlockError'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('unlockError'); ?>')<?php endif; ?>.live,
        isVerifying: <?php if ((object) ('isVerifying') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isVerifying'->value()); ?>')<?php echo e('isVerifying'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isVerifying'); ?>')<?php endif; ?>.live,
        showError: false,
        ...
        async verifyCode() {
            if (!this.unlockCode?.trim()) {
                this.unlockError = '<?php echo e(__('transfers.unlock_code_required')); ?>';
                this.showError = true;
                return;
            }
            ...
            try {
                ...
                this.unlockError = '<?php echo e(__('transfers.verification_error')); ?>';
                this.showError = true;
            } finally {
    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        <div class="relative transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg"
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-white">
                                <?php echo e(__('transfers.unlock_required')); ?>

                            </h3>
                            <p class="text-blue-100 text-sm">
                                <!--[if BLOCK]><![endif]--><?php if($currentStepData && isset($currentStepData['step'])): ?>
                                    <?php echo e($currentStepData['step']->title ?? __('transfers.transfer_step')); ?>

                                <?php else: ?>
                                    <?php echo e(__('transfers.transfer_step')); ?>
            ...
            <div class="px-6 py-6">
                    ...
                    <div class="flex items-start space-x-3 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-red-600 dark:text-red-400 font-bold text-sm leading-relaxed">
                                <!--[if BLOCK]><![endif]--><?php if($currentStepData && isset($currentStepData['step'])): ?>
                                    <?php echo e($currentStepData['step']->description ?? __('transfers.enter_unlock_code')); ?>

                                <?php else: ?>
                                    <?php echo e(__('transfers.enter_unlock_code')); ?>
                ...
                <!-- Progress Indicator -->
                <!--[if BLOCK]><![endif]--><?php if($currentStepData && isset($currentStepData['percentage'])): ?>
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                            <?php echo e(__('transfers.progress')); ?>

                        </span>
                        <span class="text-sm font-medium text-blue-600 dark:text-blue-400">
                            <?php echo e(number_format($currentStepData['percentage'], 1)); ?>%
                        </span>
                    </div>
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-2 rounded-full transition-all duration-300 ease-out" 
                             style="width: <?php echo e($currentStepData['percentage']); ?>%"></div>
                    </div>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="mb-6">
                    <label for="unlock-code" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        <?php echo e(__('transfers.unlock_code')); ?>
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               placeholder="<?php echo e(__('transfers.enter_code_placeholder')); ?>"
                               autocomplete="off"
                               spellcheck="false"
                               maxlength="20">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <h4 class="text-sm font-semibold text-blue-800 dark:text-blue-200 mb-1">
                                <?php echo e(__('transfers.need_help')); ?>

                            </h4>
                            <p class="text-sm text-blue-700 dark:text-blue-300 mb-3">
                                <?php echo e(__('transfers.contact_bank_for_unlock')); ?>
                            ...
                            <a href="<?php echo e(route('contact', ['locale' => app()->getLocale()])); ?>" 
                               class="inline-flex items-center space-x-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 transition-colors duration-150">
                                ...
                                <span><?php echo e(__('transfers.contact_support')); ?></span>
                ...
                <div class="flex flex-row justify-end space-x-3">
                    ...
                    <button @click="verifyCode()" 
                        ...
                        <span x-show="!isVerifying"><?php echo e(__('transfers.verify')); ?></span>
                        <span x-show="isVerifying" class="flex items-center space-x-2">
                            <i class="fa-solid fa-spinner fa-spin" aria-hidden="true"></i>
                            <span><?php echo e(__('transfers.verifying')); ?></span>
                        </span>
                    </button>
                </div>
            </div>
...
</script><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/components/transfer/unlock-modal.blade.php ENDPATH**/ ?>