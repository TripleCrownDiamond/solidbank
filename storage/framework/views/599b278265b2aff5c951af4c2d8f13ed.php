...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --brand-primary-hover: <?php echo e($brandPrimaryHover); ?>;
            --brand-light: <?php echo e($brandPrimaryLight); ?>;
            --brand-dark: <?php echo e($brandPrimaryDark); ?>;
            --text-primary: #1f2937;
            --bg-light: #f9fafb;
            --border-light: #e5e7eb;
            --text-muted: #6b7280;
            ...
            --bg-secondary: #f3f4f6;
            --primary-color: <?php echo e($brandPrimary); ?>;
            --success-bg: #f0fdf4;
        ...
        <div class="container">
            <div class="logo">
                ...
                <?php if(file_exists($iconPath)): ?>
                    <img src="data:image/svg+xml;base64,<?php echo e(base64_encode(file_get_contents($iconPath))); ?>" alt="<?php echo e($appName); ?>" style="max-width: 80px; height: auto;">
                <?php else: ?>
                    <img src="<?php echo e(asset('img/logo_blue.svg')); ?>" alt="<?php echo e($appName); ?>" style="max-width: 80px; height: auto;">
                <?php endif; ?>
            </div>
            ...
            <div class="footer">
                <p><?php echo e(__('common.thanks')); ?>,<br><?php echo e(getAppName()); ?></p>
                <?php
                ...
                <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid var(--border-light);">
                    <p style="margin: 0; font-size: 12px; color: var(--text-muted); line-height: 1.4;">
                        <?php if($bankConfig && $bankConfig->bank_name): ?>
                        <strong><?php echo e($bankConfig->bank_name); ?> - Services Bancaires Numériques</strong><br>
                        <?php endif; ?>
                        <?php if($bankConfig && $bankConfig->bank_address && trim($bankConfig->bank_address) !== ''): ?>
                        <?php echo e($bankConfig->bank_address); ?><br>
                        <?php endif; ?>
                        <?php if($bankConfig && $bankConfig->bank_email): ?>
                        Email: <?php echo e($bankConfig->bank_email); ?>
...
</html><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/emails/layout.blade.php ENDPATH**/ ?>