...
<?php endif; ?>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <div class="text-center">
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2"><?php echo e(__('common.session_expired')); ?></h2>
                    <p class="text-gray-600 dark:text-gray-400"><?php echo e(__('common.session_expired_redirect')); ?></p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-2"><?php echo e(__('common.redirecting')); ?></p>
                </div>
                
                <!-- Manual redirect button -->
                <div class="space-y-3">
                    <a href="<?php echo e(route('login', app()->getLocale())); ?>" 
                       class="w-full inline-flex items-center justify-center px-4 py-2 bg-brand-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-brand-primary-hover focus:bg-brand-primary-hover active:bg-brand-primary-hover focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        ...
                        <?php echo e(__('common.reconnect')); ?>
                    ...
                    <button onclick="history.back()" 
                        ...
                        <?php echo e(__('common.previous_page')); ?>
        ...
        <div class="mt-6 text-center">
            <p class="text-xs text-gray-500 dark:text-gray-400">
                <?php echo e(__('common.contact_support_if_problem_persists')); ?>
    ...
    <script>
        ...
        setTimeout(function() {
            window.location.href = '<?php echo e(route("login", app()->getLocale())); ?>';
        }, 3000);
    </script>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/errors/419.blade.php ENDPATH**/ ?>