    ...
    <div class="p-6">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                <?php echo e(__('common.my_accounts_ribs')); ?>

            </h3>
            <div class="text-sm text-gray-500 dark:text-gray-400">
                <?php echo e($accounts->count()); ?> <?php echo e(__('common.accounts')); ?>
        ...
        <?php if($user && !$user->is_admin): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 cursor-pointer" 
                                 wire:click="toggleAccount(<?php echo e($account->id); ?>)">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                                <?php echo e(__('common.account')); ?> <?php echo e($account->account_number); ?>

                                            </h4>
                                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                <?php echo e(__('register.' . strtolower($account->type))); ?> • 
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                    <?php if($account->status === 'ACTIVE'): ?> bg-brand-success/10 text-brand-success dark:bg-brand-success/20 dark:text-brand-success
                                    <?php elseif($account->status === 'INACTIVE'): ?> bg-brand-warning/10 text-brand-warning dark:bg-brand-warning/20 dark:text-brand-warning
                                    <?php else: ?> bg-brand-danger/10 text-brand-danger dark:bg-brand-danger/20 dark:text-brand-danger <?php endif; ?>">
                                    <?php echo e(__('common.' . strtolower($account->status))); ?>
                                ...
                                <?php echo e(number_format($account->balance, 2)); ?> <?php echo e($account->currency); ?>

                            </div>
                            <!--[if BLOCK]><![endif]--><?php if($account->rib): ?>
                                <div class="text-xs text-brand-success dark:text-brand-success">
                                    <?php echo e(__('common.rib_available')); ?>

                                </div>
                            <?php else: ?>
                                <div class="text-xs text-brand-danger dark:text-brand-danger">
                                    <?php echo e(__('common.no_rib')); ?>

                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                        <div class="transform transition-transform duration-200 <?php echo e($this->isAccountExpanded($account->id) ? 'rotate-180' : ''); ?>">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($this->isAccountExpanded($account->id)): ?>
                                <div class="px-4 py-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                                    <!--[if BLOCK]><![endif]--><?php if($account->rib): ?>
                                        <div class="space-y-6">
                                            ...
                                            <div class="group">
                                                <label class="block text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-2">
                                                    <?php echo e(__('common.account_number')); ?>
                                                ...
                                                <div class="relative flex items-center bg-gradient-to-r from-gray-100/50 to-gray-200/50 dark:from-gray-700 dark:to-gray-600 px-4 py-3 rounded-lg border border-gray-300/50 dark:border-gray-600 shadow-sm hover:shadow-md transition-all duration-200">
                                                    ...
                                                    <button x-data="{ copied: false }" x-on:click="navigator.clipboard.writeText('<?php echo e($account->account_number); ?>').then(() => { copied = true; setTimeout(() => copied = false, 2000); })" title="<?php echo e(__('common.copy_account_number')); ?>" class="ml-3 p-1.5 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-all duration-200">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div class="relative flex items-center bg-gradient-to-r from-brand-primary/5 to-brand-primary/10 dark:from-gray-700 dark:to-gray-600 px-4 py-3 rounded-lg border border-brand-primary/30 dark:border-gray-600 shadow-sm hover:shadow-md transition-all duration-200">
                                                    <div class="text-sm text-gray-800 dark:text-white font-mono flex-1 tracking-wide">
                                                        <?php echo e($account->rib->iban); ?>

                                                    </div>
                                                    <button x-data="{ copied: false }" x-on:click="navigator.clipboard.writeText('<?php echo e($account->rib->iban); ?>').then(() => { copied = true; setTimeout(() => copied = false, 2000); })" title="<?php echo e(__('common.copy_iban')); ?>" class="ml-3 p-1.5 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-all duration-200">
                                                        <svg class="w-4 h-4 text-green-600 dark:text-green-400 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="copied" x-cloak>
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                        </svg>
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="!copied">
                                            ...
                                            <div class="group">
                                                ...
                                                <div class="relative flex items-center bg-gradient-to-r from-brand-secondary/5 to-brand-secondary/10 dark:from-gray-700 dark:to-gray-600 px-4 py-3 rounded-lg border border-brand-secondary/30 dark:border-gray-600 shadow-sm hover:shadow-md transition-all duration-200">
                                                    <div class="text-sm text-gray-800 dark:text-white font-mono flex-1 tracking-wide">
                                                        <?php echo e($account->rib->swift); ?>

                                                    </div>
                                                    <button x-data="{ copied: false }" x-on:click="navigator.clipboard.writeText('<?php echo e($account->rib->swift); ?>').then(() => { copied = true; setTimeout(() => copied = false, 2000); })" title="<?php echo e(__('common.copy_swift')); ?>" class="ml-3 p-1.5 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-all duration-200">
                                                        <svg class="w-4 h-4 text-green-600 dark:text-green-400 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="copied" x-cloak>
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                        </svg>
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="!copied">
                                            ...
                                            <div class="group">
                                                <label class="block text-xs font-semibold text-brand-accent dark:text-brand-accent uppercase tracking-wider mb-2">
                                                    <?php echo e(__('common.bank_name')); ?>
                                                ...
                                                <div class="relative flex items-center bg-gradient-to-r from-brand-accent/5 to-brand-accent/10 dark:from-gray-700 dark:to-gray-600 px-4 py-3 rounded-lg border border-brand-accent/30 dark:border-gray-600 shadow-sm hover:shadow-md transition-all duration-200">
                                                    <div class="text-sm text-gray-800 dark:text-white flex-1 font-medium">
                                                        <?php echo e($account->rib->bank_name); ?>

                                                    </div>
                                                    <button x-data="{ copied: false }" x-on:click="navigator.clipboard.writeText('<?php echo e($account->rib->bank_name); ?>').then(() => { copied = true; setTimeout(() => copied = false, 2000); })" title="<?php echo e(__('common.copy_bank_name')); ?>" class="ml-3 p-1.5 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-md transition-all duration-200">
                                                        <svg class="w-4 h-4 text-green-600 dark:text-green-400 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="copied" x-cloak>
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                        </svg>
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-show="!copied">
                                        ...
                                        <div class="mt-6 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border-l-4 border-brand-primary">
                                            <div class="flex items-center text-xs text-gray-600 dark:text-gray-300">
                                                ...
                                                <span class="font-medium"><?php echo e(__('common.rib_created_at')); ?>:</span>
                                                <span class="ml-1"><?php echo e($account->rib->created_at->format('d/m/Y H:i')); ?></span>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="text-center py-8">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                                <?php echo e(__('common.no_rib_available')); ?>

                                            </h3>
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                <?php echo e(__('common.rib_will_be_generated')); ?>
                                    ...
                                    <!-- Suspension Details -->
                                    <!--[if BLOCK]><![endif]--><?php if($account->status === 'SUSPENDED' && ($account->suspension_reason || $account->suspension_instructions)): ?>
                                        <div class="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                                            <div class="flex items-center mb-3">
                                                ...
                                                <h4 class="text-sm font-semibold text-red-800 dark:text-red-200">
                                                    <?php echo e(__('common.account_suspended')); ?>

                                                </h4>
                                            </div>
                                            
                                            <!--[if BLOCK]><![endif]--><?php if($account->suspension_reason): ?>
                                                <div class="mb-3">
                                                    ...
                                                    <p class="text-sm text-red-700 dark:text-red-300 leading-relaxed">
                                                        <?php echo e($account->suspension_reason); ?>

                                                    </p>
                                                </div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            
                                            <!--[if BLOCK]><![endif]--><?php if($account->suspension_instructions): ?>
                                                <div>
                                                    <h5 class="text-xs font-medium text-red-700 dark:text-red-300 uppercase tracking-wide mb-1">
                                                    ...
                                                    <p class="text-sm text-red-700 dark:text-red-300 leading-relaxed">
                                                        <?php echo e($account->suspension_instructions); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        <?php echo e(__('common.no_accounts')); ?>

                    </h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        <?php echo e(__('common.contact_admin_for_account')); ?>
        ...
        <?php else: ?>
            <div class="text-center py-8">
                <p class="text-gray-500 dark:text-gray-400">
                    <?php echo e(__('common.admin_no_personal_accounts')); ?>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('start-copy-timer', (event) => {
                setTimeout(() => {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').removeCopiedState(event.value);
                }, 2000);
            });
        });
    </script>
</div><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/livewire/user-account-ribs.blade.php ENDPATH**/ ?>