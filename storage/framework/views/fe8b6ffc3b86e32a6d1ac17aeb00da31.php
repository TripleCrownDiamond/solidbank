...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(__('common.my_stats')); ?></h2>
        <div class="flex items-center space-x-4">
            <div class="h-1 w-16 bg-gradient-to-r from-brand-primary to-brand-accent rounded-full"></div>
        </div>
    </div>
    
    <!--[if BLOCK]><![endif]--><?php if($hasActiveAccount): ?>
    <!-- Account Balance Card -->
    <div class="mb-6 p-6 rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg">
        <h3 class="text-lg font-medium mb-2"><?php echo e(__('common.account_balance')); ?></h3>
        <div class="flex items-baseline gap-2">
            <span class="text-xl font-bold"><?php echo e($currency); ?></span>
            <span class="text-2xl font-bold"><?php echo e($formattedBalance); ?></span>
        </div>
    </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!empty($statsCards)): ?>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <!--[if BLOCK]><![endif]--><?php if(isset($card['isTransaction']) && $card['isTransaction']): ?>
                                <p class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-<?php echo e($card['color']); ?> transition-colors duration-300 leading-tight">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(isset($card['subtitle'])): ?>
                                        <span class="block text-xs font-medium text-gray-500 dark:text-gray-400 group-hover:text-<?php echo e($card['color']); ?>/70"><?php echo e($card['subtitle']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </p>
                            <?php elseif(isset($card['isCard']) && $card['isCard']): ?>
                                <p class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-<?php echo e($card['color']); ?> transition-colors duration-300 leading-tight">
                                    <?php echo e($card['amountValue']); ?>

                                    <!--[if BLOCK]><![endif]--><?php if(isset($card['value'])): ?>
                                        <span class="block text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-<?php echo e($card['color']); ?>/70 mt-1"><?php echo e($card['value']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if(isset($card['subtitle'])): ?>
                                        <span class="block text-xs font-medium text-gray-500 dark:text-gray-400 group-hover:text-<?php echo e($card['color']); ?>/70 mt-1"><?php echo e($card['subtitle']); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </p>
                            <?php elseif(isset($card['isCrypto']) && $card['isCrypto']): ?>
                                <p class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-<?php echo e($card['color']); ?> transition-colors duration-300 leading-tight">
                                    <?php echo e($card['value']); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(!$hasActiveAccount && empty($statsCards)): ?>
    <div class="text-center py-12">
        ...
        <p class="text-brand-secondary font-medium"><?php echo e(__('common.no_active_account_stats')); ?></p>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2"><?php echo e(__('common.activate_account_to_view_stats')); ?></p>
    </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/livewire/user-dashboard-stats.blade.php ENDPATH**/ ?>