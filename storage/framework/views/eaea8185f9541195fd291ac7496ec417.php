<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-2.5 sm:px-0 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div class="w-full <?php echo e($maxWidth); ?> mt-6 px-2.5 sm:px-6 py-4 shadow-md overflow-hidden sm:rounded-lg bg-white dark:bg-gray-800">
        <?php echo e($slot); ?>

    </div>
</div><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/components/authentication-card.blade.php ENDPATH**/ ?>