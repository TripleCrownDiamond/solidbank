...
[$__name, $__params] = $__split('hero-slider');

$__html = app('livewire')->mount($__name, $__params, 'lw-1511864758-0', $__slots ?? [], get_defined_vars());
        ...
        <section class="py-8 sm:py-12 lg:py-16 bg-gray-50 dark:bg-gray-900 relative">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h2 class="text-base text-indigo-600 dark:text-indigo-400 font-semibold tracking-wide uppercase"><?php echo e(__('common.features')); ?></h2>
                    <p class="mt-2 text-2xl sm:text-3xl lg:text-4xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white">
                        <?php echo e(__('common.everything_you_need')); ?>
                ...
                <div class="mt-8 sm:mt-10">
                    <div class="space-y-8 sm:space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-6 lg:gap-x-8 md:gap-y-8 lg:gap-y-10">
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white"><?php echo e(__('common.secure_banking')); ?></h3>
                                <p class="mt-2 text-base text-gray-500 dark:text-gray-300">
                                    <?php echo e(__('common.secure_banking_desc')); ?>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white"><?php echo e(__('common.fast_transactions')); ?></h3>
                                <p class="mt-2 text-base text-gray-500 dark:text-gray-300">
                                    <?php echo e(__('common.fast_transactions_desc')); ?>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white"><?php echo e(__('common.support_24_7')); ?></h3>
                                <p class="mt-2 text-base text-gray-500 dark:text-gray-300">
                                    <?php echo e(__('common.support_24_7_desc')); ?>
                        ...
                        <div class="relative">
                            ...
                            <div class="ml-16">
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white"><?php echo e(__('common.investment_solutions')); ?></h3>
                                <p class="mt-2 text-base text-gray-500 dark:text-gray-300">
                                    <?php echo e(__('common.investment_solutions_desc')); ?>
        ...
        <section class="relative overflow-hidden rounded-2xl mb-12">
            ...
            <div class="relative z-20 max-w-4xl mx-auto text-center py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white">
                    <span class="block"><?php echo e(__('common.ready_to_get_started')); ?></span>
                    <span class="block"><?php echo e(__('common.join_bank_today', ['bank_name' => getAppName()])); ?></span>
                </h2>
                <p class="mt-4 text-base sm:text-lg leading-6 text-white/90 max-w-2xl mx-auto">
                    <?php echo e(__('common.experience_future_banking')); ?>

                </p>
                <a href="<?php echo e(route('locale.register', ['locale' => app()->getLocale()])); ?>" class="mt-6 sm:mt-8 w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-white hover:bg-gray-50 hover:text-blue-500 transition duration-200">
                    <?php echo e(__('common.sign_up_free')); ?>
        ...
        <section class="max-w-6xl mx-auto">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
                <div class="p-4 transform hover:scale-105 transition-all duration-300">
                    ...
                    <div class="text-sm sm:text-base text-gray-500 dark:text-gray-300 mt-1"><?php echo e(__('common.satisfied_customers')); ?></div>
                </div>
                <div class="p-4 transform hover:scale-105 transition-all duration-300 animate-slide-up" style="animation-delay: 0.1s;">
                    <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 animate-bounce-slow"><?php echo e(__('common.24_7')); ?></div>
                    <div class="text-sm sm:text-base text-gray-500 dark:text-gray-300 mt-1"><?php echo e(__('common.support')); ?></div>
                </div>
                <div class="p-4 transform hover:scale-105 transition-all duration-300 animate-slide-up" style="animation-delay: 0.2s;">
                    <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 animate-float"><?php echo e(__('common.zero_euro')); ?></div>
                    <div class="text-sm sm:text-base text-gray-500 dark:text-gray-300 mt-1"><?php echo __('common.opening_fees'); ?></div>
                </div>
                <div class="p-4 transform hover:scale-105 transition-all duration-300 animate-slide-up" style="animation-delay: 0.3s;">
                    ...
                    <div class="text-sm sm:text-base text-gray-500 dark:text-gray-300 mt-1"><?php echo e(__('common.platform_availability')); ?></div>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20">
                    ...
                    <div class="font-bold mb-2 text-blue-600 text-center"><?php echo e(__('common.advanced_security')); ?></div>
                    <div class="text-gray-500 dark:text-gray-300 text-sm text-center"><?php echo e(__('common.advanced_security_desc')); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.1s;">
                    ...
                    <div class="font-bold mb-2 text-blue-600 text-center"><?php echo e(__('common.instant_transactions')); ?></div>
                    <div class="text-gray-500 dark:text-gray-300 text-sm text-center"><?php echo e(__('common.instant_transactions_desc')); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.2s;">
                    ...
                    <div class="font-bold mb-2 text-blue-600 text-center"><?php echo e(__('common.human_support_24_7')); ?></div>
                    <div class="text-gray-500 dark:text-gray-300 text-sm text-center"><?php echo e(__('common.human_support_24_7_desc')); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-all duration-300 animate-slide-up hover:shadow-2xl border border-transparent hover:border-blue-600/20" style="animation-delay: 0.3s;">
                    ...
                    <div class="font-bold mb-2 text-blue-600 text-center"><?php echo e(__('common.investment_solutions')); ?></div>
                    <div class="text-gray-500 dark:text-gray-300 text-sm text-center"><?php echo e(__('common.investment_solutions_desc')); ?></div>
                </div>
            </div>
        </section>
        ...
        <section class="py-8 sm:py-12 lg:py-16 relative overflow-hidden bg-gray-50 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-base text-blue-600 dark:text-blue-400 font-semibold tracking-wide uppercase"><?php echo e(__('common.our_cards')); ?></h2>
                    <p class="mt-2 text-2xl sm:text-3xl lg:text-4xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white">
                        <?php echo e(__('common.discover_our_cards')); ?>

                    </p>
                    <p class="mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300 lg:mx-auto">
                        <?php echo e(__('common.explore_card_benefits')); ?>

                    </p>
                </div>

                <?php if (isset($component)) { $__componentOriginal0946aad286d1e424d1772087914a5c46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0946aad286d1e424d1772087914a5c46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card-slider','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card-slider'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal0946aad286d1e424d1772087914a5c46)): ?>
<?php $attributes = $__attributesOriginal0946aad286d1e424d1772087914a5c46; ?>
<?php unset($__attributesOriginal0946aad286d1e424d1772087914a5c46); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal0946aad286d1e424d1772087914a5c46)): ?>
<?php $component = $__componentOriginal0946aad286d1e424d1772087914a5c46; ?>
<?php unset($__componentOriginal0946aad286d1e424d1772087914a5c46); ?>
<?php endif; ?>
                </div>
            </div>
        </section>
        ...
        <section class="py-8 sm:py-12 lg:py-16 mt-8 mb-8 relative overflow-hidden rounded-xl border border-blue-200/30 dark:border-blue-700/30">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center">
                    <h2 class="text-base text-blue-600 dark:text-blue-400 font-semibold tracking-wide uppercase"><?php echo e(__('common.crypto_wallets')); ?></h2>
                    <p class="mt-2 text-2xl sm:text-3xl lg:text-4xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white">
                        <?php echo e(__('common.manage_crypto_assets')); ?>

                    </p>
                    <p class="mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300 lg:mx-auto">
                        <?php echo e(__('common.secure_crypto_wallet_management')); ?>
                ...
                <div class="mt-8 sm:mt-10">
                    <div class="space-y-8 sm:space-y-10 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-6 lg:gap-x-8 md:gap-y-8 lg:gap-y-10">
                        ...
                        <div class="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl p-6 border border-blue-200/50 dark:border-blue-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                            ...
                            <div>
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-2"><?php echo e(__('common.multi_crypto_support')); ?></h3>
                                <p class="text-base text-gray-600 dark:text-gray-300 mb-4">
                                    <?php echo e(__('common.multi_crypto_support_desc')); ?>
                                ...
                                <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.bitcoin_support')); ?>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.ethereum_support')); ?>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.other_altcoins')); ?>
                        ...
                        <div class="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl p-6 border border-blue-200/50 dark:border-blue-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                            ...
                            <div>
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-2"><?php echo e(__('common.secure_storage')); ?></h3>
                                <p class="text-base text-gray-600 dark:text-gray-300 mb-4">
                                    <?php echo e(__('common.secure_storage_desc')); ?>
                                ...
                                <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.cold_storage')); ?>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.multi_signature')); ?>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.private_keys_control')); ?>
                        ...
                        <div class="relative bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl p-6 border border-blue-200/50 dark:border-blue-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                            ...
                            <div>
                                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-2"><?php echo e(__('common.instant_crypto_transfers')); ?></h3>
                                <p class="text-base text-gray-600 dark:text-gray-300 mb-4">
                                    <?php echo e(__('common.instant_crypto_transfers_desc')); ?>
                                ...
                                <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.lightning_fast')); ?>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <?php echo e(__('common.global_transfers')); ?>
                ...
                <div class="mt-8 sm:mt-10 text-center">
                    <a href="<?php echo e(route('locale.register', ['locale' => app()->getLocale()])); ?>" class="inline-flex items-center px-8 py-4 border border-blue-200/30 dark:border-blue-700/30 text-base font-medium rounded-2xl text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 shadow-xl hover:shadow-2xl backdrop-blur-sm bg-white/10 dark:bg-gray-800/10 hover:scale-105">
                        <?php echo e(__('common.start_crypto_journey')); ?>
        ...
        <section class="py-8 sm:py-12 lg:py-16 mt-8 mb-8 relative overflow-hidden rounded-xl border border-blue-200/30 dark:border-blue-700/30">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center mb-8">
                    <h2 class="text-base text-blue-600 dark:text-blue-400 font-semibold tracking-wide uppercase"><?php echo e(__('common.crypto_recovery_program')); ?></h2>
                    <p class="mt-2 text-2xl sm:text-3xl lg:text-4xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-white">
                        <?php echo e(__('common.crypto_recovery_program')); ?>

                    </p>
                    <p class="mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300 lg:mx-auto">
                        <?php echo e(__('common.crypto_recovery_desc')); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('common.recovery_success_rate')); ?></div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center border border-gray-200 dark:border-gray-700">
                        <div class="text-3xl font-bold text-blue mb-2">€15M+</div>
                        <div class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('common.funds_recovered')); ?></div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center border border-gray-200 dark:border-gray-700">
                        <div class="text-3xl font-bold text-blue mb-2">2,450+</div>
                        <div class="text-gray-600 dark:text-gray-300 text-sm"><?php echo e(__('common.successful_recoveries')); ?></div>
                    </div>
                </div>
...
[$__name, $__params] = $__split('crypto-recovery-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1511864758-1', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-200/50 dark:border-blue-700/50 p-6 max-w-md mx-auto">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2"><?php echo e(__('common.need_crypto_recovery_help')); ?></h3>
                        <p class="text-gray-600 dark:text-gray-300 text-sm mb-4"><?php echo e(__('common.expert_team_recovery_support')); ?></p>
                        <a href="<?php echo e(route('crypto-refund', ['locale' => app()->getLocale()])); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-medium rounded-lg shadow-lg transition duration-300 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                            </svg>
                            <?php echo e(__('common.request_refund')); ?>
        ...
        <section class="py-8 sm:py-10 lg:py-12 mt-4 mb-4 bg-gradient-to-br from-blue-600 via-blue-700 to-teal-800 text-white relative overflow-hidden rounded-xl border border-blue-400/30">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <h2 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4"><?php echo e(__('loan.request_title')); ?></h2>
                    <p class="text-lg sm:text-xl text-blue-100 mb-4 max-w-3xl mx-auto"><?php echo e(__('loan.request_description')); ?></p>
                    <div class="bg-green-500/20 border border-green-400/30 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
                        <p class="text-lg font-semibold text-green-100"><?php echo e(__('common.lending_capacity')); ?></p>
                        <p class="text-sm text-green-200 mt-1"><?php echo e(__('common.lending_capacity_description')); ?></p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        class="inline-flex items-center px-8 py-4 bg-blue-400 text-blue-900 font-semibold rounded-lg hover:bg-blue-300 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                            ...
                            <?php echo e(__('loan.request_loan')); ?>
                        ...
                        <div class="flex items-center text-blue-100">
                            ...
                            <span class="text-sm"><?php echo e(__('loan.fast_approval')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="max-w-4xl mx-auto py-8 sm:py-10 lg:py-12 mt-4 mb-4">
            <h2 class="text-2xl font-bold text-brand-primary mb-4"><?php echo e(__('common.our_rates')); ?></h2>
            <div class="overflow-x-auto rounded-xl shadow-lg">
                <table class="min-w-full bg-white dark:bg-gray-800 rounded-xl overflow-hidden">
                    <thead>
                        <tr class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                            <th class="py-3 px-4 text-left text-white"><?php echo e(__('common.cards_and_services')); ?></th>
                            <th class="py-3 px-4 text-left text-white"><?php echo e(__('common.price_euro')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.online_account_management')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.email_alerts')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.visa_card')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.mastercard')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.american_express')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition">
                            <td class="py-3 px-4 text-brand-primary dark:text-blue-300"><?php echo e(__('common.atm_withdrawal_eurozone')); ?></td>
                            <td class="py-3 px-4 font-bold text-blue"><?php echo e(__('common.free')); ?></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="text-right mt-2">
                <a href="<?php echo e(route('services', ['locale' => app()->getLocale()])); ?>" class="text-brand-primary hover:underline"><?php echo e(__('common.see_all_rates')); ?></a>
            </div>
        </section>

        <!-- FAQ (Accordéon Alpine.js) -->
        <section class="max-w-4xl mx-auto py-8 sm:py-10 lg:py-12 mt-4 mb-4">
            <h2 class="text-2xl font-bold text-brand-primary mb-4"><?php echo e(__('common.frequently_asked_questions')); ?></h2>
            <div x-data="{open:null}" class="space-y-2">
                <div class="bg-white dark:bg-gray-800 rounded shadow-lg">
                    <button @click="open===1?open=null:open=1" class="w-full text-left px-6 py-4 font-bold text-brand-primary dark:text-blue-300 flex justify-between items-center"><?php echo e(__('common.how_to_open_account')); ?> <span x-text="open===1?'−':'+'"></span></button>
                    <div x-show="open===1" x-transition class="px-6 pb-4 text-gray-600 dark:text-gray-300"><?php echo e(__('common.how_to_open_account_answer')); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded shadow-lg">
                    <button @click="open===2?open=null:open=2" class="w-full text-left px-6 py-4 font-bold text-brand-primary dark:text-blue-300 flex justify-between items-center"><?php echo e(__('common.is_card_really_free')); ?> <span x-text="open===2?'−':'+'"></span></button>
                    <div x-show="open===2" x-transition class="px-6 pb-4 text-gray-600 dark:text-gray-300"><?php echo e(__('common.is_card_really_free_answer')); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded shadow-lg">
                    <button @click="open===3?open=null:open=3" class="w-full text-left px-6 py-4 font-bold text-brand-primary dark:text-blue-300 flex justify-between items-center"><?php echo e(__('common.how_to_contact_support')); ?> <span x-text="open===3?'−':'+'"></span></button>
                    <div x-show="open===3" x-transition class="px-6 pb-4 text-gray-600 dark:text-gray-300"><?php echo e(__('common.how_to_contact_support_answer')); ?></div>
                </div>
            </div>
        </section>
        ...
        <section class="relative max-w-7xl mx-auto rounded-2xl shadow-lg overflow-hidden min-h-[200px] py-8 sm:py-10 lg:py-12 mt-4 mb-4">
            ...
            <div class="relative z-20 p-8 text-white text-center flex flex-col justify-center min-h-[200px]">
                <h2 class="text-3xl font-bold mb-4"><?php echo e(__('common.stay_informed_news', ['bank_name' => getAppName()])); ?></h2>
                <p class="mb-6 text-white/90 text-lg"><?php echo e(__('common.receive_exclusive_offers')); ?></p>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1511864758-2', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/livewire/pages/home.blade.php ENDPATH**/ ?>