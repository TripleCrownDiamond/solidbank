    ...
    function heroSlider() {
        return {
            ...
            slides: [
                {
                    image: 'slide1.jpg',
                    offer: '<?php echo e(__('common.welcome_offer')); ?>',
                    title: '<?php echo e(getAppName()); ?>&nbsp;: <span class="text-blue-100"><?php echo e(__('common.banking_future')); ?></span>',
                    description: '<?php echo e(__('common.revolutionary_banking_experience')); ?>',
                    cta1Text: '<?php echo e(__('common.open_account')); ?>',
                    cta1Link: '<?php echo e(route('locale.register', ['locale' => app()->getLocale()])); ?>',
                    cta2Text: '<?php echo e(__('common.learn_more')); ?>',
                    cta2Link: '<?php echo e(route('services', ['locale' => app()->getLocale()])); ?>',
                    stat1Value: '<?php echo e(__('common.zero_euro')); ?>',
                    stat1Label: '<?php echo e(__('common.opening_fees')); ?>',
                    stat2Value: '<?php echo e(__('common.two_minutes')); ?>',
                    stat2Label: '<?php echo e(__('common.quick_opening')); ?>',
                    stat3Value: '<?php echo e(__('common.24_7')); ?>',
                    stat3Label: '<?php echo e(__('common.customer_support')); ?>',
                },
                {
                    image: 'slide2.jpg',
                    offer: '<?php echo e(__('common.secure_and_fast')); ?>',
                    title: '<?php echo e(getAppName()); ?>&nbsp;: <span class="text-blue-100"><?php echo e(__('common.your_finances_secured')); ?></span>',
                    description: '<?php echo e(__('common.advanced_security_and_instant_transactions')); ?>',
                    cta1Text: '<?php echo e(__('common.open_account')); ?>',
                    cta1Link: '<?php echo e(route('locale.register', ['locale' => app()->getLocale()])); ?>',
                    cta2Text: '<?php echo e(__('common.explore_features')); ?>',
                    cta2Link: '<?php echo e(route('services', ['locale' => app()->getLocale()])); ?>',
                    stat1Value: '50K+',
                    stat1Label: '<?php echo e(__('common.satisfied_clients')); ?>',
                    stat2Value: '€2.5M+',
                    stat2Label: '<?php echo e(__('common.transactions_processed')); ?>',
                    stat3Value: '99.9%',
                    stat3Label: '<?php echo e(__('common.uptime_guarantee')); ?>',
                },
                {
                    image: 'slide3.jpg',
                    offer: '<?php echo e(__('common.global_reach')); ?>',
                    title: '<?php echo e(getAppName()); ?>&nbsp;: <span class="text-blue-100"><?php echo e(__('common.banking_without_borders')); ?></span>',
                    description: '<?php echo e(__('common.manage_your_money_anywhere_anytime')); ?>',
                    cta1Text: '<?php echo e(__('common.open_account')); ?>',
                    cta1Link: '<?php echo e(route('locale.register', ['locale' => app()->getLocale()])); ?>',
                    cta2Text: '<?php echo e(__('common.contact_us')); ?>',
                    cta2Link: '<?php echo e(route('contact', ['locale' => app()->getLocale()])); ?>',
                    stat1Value: '100+',
                    stat1Label: '<?php echo e(__('common.countries_supported')); ?>',
                    stat2Value: '24/7',
                    stat2Label: '<?php echo e(__('common.multilingual_support')); ?>',
                    stat3Value: 'Fast',
                    stat3Label: '<?php echo e(__('common.international_transfers')); ?>',
                },
            ],
            init() {
                setInterval(() => {
...
<?php /**PATH D:\Backup Desktop\projets\solidbank\resources\views/livewire/hero-slider.blade.php ENDPATH**/ ?>